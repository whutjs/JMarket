...
app.directive('ionicCityPicker', ['$ionicPopup', '$timeout','CityPickerService','$ionicScrollDelegate','$ionicModal', function ($ionicPopup, $timeout,CityPickerService, $ionicScrollDelegate,$ionicModal) {
  return {
    restrict: 'AE',
    template:  '<input type="text"  placeholder={{vm.placeholder}} ng-model="citydata"  class={{vm.cssClass}} readonly required name="cate" style="width:100%; background-color: #fff; border: 1px solid #ddd; border-radius: 2px;padding: 18px 15px;height: 34px;">',
    scope: {
      citydata: '=',
      backdrop:'@',
    ...
    link: function (scope, element, attrs) {
        ...
        element.on("click", function () {
            ...
            attrs.checked=true;
            $ionicModal.fromTemplateUrl('js/ionic-citypicker/src/city-picker-modal.html', {
              scope: scope,
