                  ...
                  <ul class="nav bg clearfix">
                    ...
                    <li>
                      <a href="<%=path %>/personalPageChangeWechat.jsp">
                        <i class="fa fa-weixin  text-success" style="background:#eee;"></i>
            ...
            <div class="col">
                    ...
                    <div class="col-sm-7">
                      ...
                      <div class="clear m-b">
                        <div class="m-b m-t-sm">
                          <span class="h4 text-dark-dker">${user.UEmail }</span>
                        </div>
                        <p class="m-b">
              ...
              <div class="wrapper bg-white b-b">
                <ul class="nav nav-pills nav-sm">
                  <li class="active"><a>更换微信号</a></li>
                </ul>
              </div>
              <div class="div-box">
                <form class="chg-wechat-form" id="chg_wechat_form" action="<%=path%>/usercenter/wechat">
                  <div class="control-group">
                    <label class="control-label"><i style="color: red"></i> 新微信号</label>
                    <div class="controls">
                      <input type="text" class="input-xlarge"  id="wechat" value="" name="newWeChat">
                      <p class="help-block" id="tip_wechat">*新的微信号</p>
                    </div>
                  </div>
