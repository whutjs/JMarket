              ...
              <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0"
                ...
                <nav class="nav-primary hidden-xs">
                  <ul class="nav bg clearfix">
                    ...
                    <li>
                      <a href="<%=path %>/usercenter/item" class="auto">
                        <i class="fa fa-shopping-cart text-danger-lter" style="background:#eee;"></i>
                  ...
                  <!--  <ul class="nav" data-ride="collapse">
                    <li class="hidden-nav-xs padder m-t m-b-sm text-xs text-muted text-active">
                      我的物品
                    </li>
                    <li>
                      <a href="<%=path %>/usercenter/item" class="auto">
                        ...
                        <i class="fa fa-shopping-cart text-danger-lter text-active">
                        </i>
                        <span>我的发布</span>
                      </a>
                    </li>
            ...
            <div class="col">
              ...
              <div class="wrapper bg-white b-b">
                <ul class="nav nav-pills nav-sm">
                  <li class="active"><a href="">所有发布</a></li>
                </ul>
              </div>
              <div class="post-list">
               <c:forEach var="result" items="${items4user}">
                    ...
                    <div class="panel-body">
                      <div class="m-b">
                       ...
                       ${result["IName"]}
                        ...
                        <c:set value="${ result['IId']}" var="id"/> 
                        <img src="<%=path %>/${photo4useritem[id]}"
                             class="b b-a wrapper-xs bg-white img-responsive center-block">
                        <div class="m-t-sm">
                          <a href="<%=path %>/usercenter/changeitem?itemid=${result['IId']}" class="text-warning m-xs"><i class="fa fa-pencil"></i></a>
                          <a href="<%=path %>/usercenter/deleteitem?itemid=${result['IId']}" class="text-success m-xs"><i class="fa fa-trash-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
