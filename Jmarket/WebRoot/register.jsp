      ...
      <div class="father-container">
        ...
        <div class="content-container">
            ...
            <div class="col-md-12">
                ...
                <form class="register-form" id="register_form" action="<%=path %>/register/index" method="post">
                    <!-- progressbar -->
                    <ul id="progressbar">
                    ...
                    <fieldset style="opacity: 1; display: block;">
                        ...
                        <div class="input-group input-group-line">
                            ...
                            <input type="email" class="form-control register-input" id="input_email" placeholder="交大邮箱" aria-describedby="basic-addon1" name="UEmail">
                        </div>
                        <p id="err_mail_tip" style="display: none; text-align: left; "></p>
                        <s:actionerror/>
                        <!--  style="text-align: left; " -->
                        <div class="input-group input-group-line">
                            <span class="input-group-addon" id="basic-addon2"><i class="fa fa-lock"></i></span>
                            <input type="password" class="form-control register-input" id="input_password" placeholder="6-20个数字或字母" aria-describedby="basic-addon2" name="UPassword">
                        </div>
                          <p id="err_mail_psw_tip" style="display: none; text-align: left;"></p>
                        <div class="input-group input-group-line">
                        ...
                        <p id="err_mail_psw_again_tip" style="display: none; text-align: left;"></p>
                       
                        <input type="submit" name="next" class="next action-button btn-disabled" id="next_button" value="下一步" disabled="disabled">
                        <div class="form-group" style="float: right;">
                            已有账号，请<a href="<%=path %>/login.jsp" id="login">登录</a>
                        </div>
                        <!--<a type="button" name="next" class="next action-button" id="register_next" value="Next" onclick="location.href='http://www.baidu.com/'"></a>-->
                    </fieldset>
                    <!--<fieldset style="display: none; left: 0%; opacity: 0;">-->
                        <!--<h3 class="fs-subtitle">验证码</h3>-->
                        <!--<input type="text" class="code" name="code" placeholder="邮箱验证码">-->
                        <!--<input type="button" name="next" class="next action-button" value="提交" onsubmit="return false;">-->
...
<script type="text/javascript" src="<%=path %>/myjs/register.js"></script>
