                  ...
                  <ul class="nav bg clearfix">
                    ...
                    <li>
                      <a href="<%=path %>/personalPageChangePhone.jsp">
                        <i class="fa fa-phone  text-success-dker" style="background:#eee;"></i>
            ...
            <div class="col">
              ...
              <div class="wrapper bg-white b-b">
                <ul class="nav nav-pills nav-sm">
                  <li class="active"><a>更换手机号</a></li>
                </ul>
              </div>
              <div class="div-box">
                <form class="chg-phone-form" id="chg_phone_form" action="<%=path %>/usercenter/phone">
                  <div class="control-group">
                    <label class="control-label"><i style="color: red"></i> 新手机号</label>
                    <div class="controls">
                      <input type="text" class="input-xlarge"  id="phone" value="" name="newphone">
                      <p class="help-block" id="tip_phone">*新的手机号</p>
                    </div>
                  </div>
