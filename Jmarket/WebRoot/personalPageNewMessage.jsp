...
<head>
  ...
  <link href="<%=path %>/mycss/personal.css" rel="stylesheet" type="text/css">
  <title>个人中心-消息</title>
              ...
              <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0"
                ...
                <nav class="nav-primary hidden-xs">
                  <ul class="nav bg clearfix">
                    ...
                    <li>
                      <a href="<%=path %>/personalPageChangeQQ.jsp">
                        <i class="fa fa-qq  text-success-dk"></i>
                    ...
                    <li>
                      <a href="<%=path %>/usercenter/message?type=2">
                        <i class="fa fa-comment text-dark" style="background:#eee;"></i>
                  ...
                  <ul class="nav text-sm">
                    ...
                    <li>
                      <a href="<%=path %>/usercenter/message?type=2">
                        <i class="fa fa-comment text-dark text-active"></i>
            ...
            <div class="col">
              ...
              <div class="wrapper bg-white b-b">
                <ul class="nav nav-pills nav-sm">
                  <li class="active"><a>我的消息</a></li>
                </ul>
              </div>
              
              <div class="post-list" style="margin-left: 0px;">
                <p class="slide" style="text-align: center;background-color: #FFF;padding: 10px 0;color: #000;margin-bottom: 0px;border: 1px solid #eee;"><a href="javascript:void(0);" style="display: block;" id="btn_slide1">我评论的
</a></p>
                <div id="panel1" style="padding: 15px;background-color: #fff;">
                 <c:forEach var="result" items="${usermessage}">
              	<c:set var="messageuser" value='${result["TUser"]}' scope="page"></c:set>
                  <div style="padding: 15px;">
                    <a class="pull-left thumb-sm avatar m-l-n-md">
                             <c:if test="${empty messageuser.UImage }">
                                <img src="<%=path %>/images/user.png" style="width:40px;height:40px;">
                             </c:if>
                             <c:if test="${not empty messageuser.UImage }">
                             	<img src="<%=path %>/${messageuser.UImage}" style="width:40px;height:40px;">
                             </c:if>
                    </a>
                    <div class="m-l-lg m-b-lg panel b-a lt" style="background-color: #f4f4f4;">
                      <div class="panel-heading pos-rlt b-light">
                        <span class="arrow arrow-light left"></span>
                        <a href="">${messageuser["UName"]}</a>
                        <span class="text-muted m-l-sm pull-right font-size-12">
                          ${result["MDate"] }
                        </span>
                      </div>
                      <div class="panel-body">
                        <div>${result["MContent"] }</div>
                      </div>
                    </div>
                  </div>
                  </c:forEach>
                ...
                <p class="slide" style="text-align: center;background-color: #FFF;padding: 10px 0;color: #000;margin-top: 15px;margin-bottom: 0px;border: 1px solid #eee;"><a href="javascript:void(0);" style="display: block;" 

id="btn_slide2">回复我的</a></p>
             
                  <div id="panel2" style="display: none;padding: 15px;background-color: #fff;">
                  <c:forEach var="result" items="${reply4user}">
              	<c:set var="messageuser" value='${result["TUser"]}' scope="page"></c:set>
                  <div style="padding: 15px;">
                    <a class="pull-left thumb-sm avatar m-l-n-md">
...
id="btn_slide3">关于我的物品的评论</a></p>
              
                  <div id="panel3" style="display: none;padding: 15px;background-color: #fff;">
                   <c:forEach var="result" items="${message4user}">
              	<c:set var="messageuser" value='${result["TUser"]}' scope="page"></c:set>
                  <div style="padding: 15px;">
                    <a class="pull-left thumb-sm avatar m-l-n-md">
                             <c:if test="${empty messageuser.UImage }">
...
<script src="<%=path %>/myjs/toggle.js"></script>
