          ...
          <section class="dropdown-menu aside-xl animated fadeInUp">
            <section class="panel bg-white">
              <div class="panel-heading b-light bg-light">
                <strong>您有 <span class="count" style="display: inline;">3</span> 条回复</strong>
              </div>
                  ...
                  <ul class="nav bg clearfix">
                    ...
                    <li>
                      <a href="<%=path %>/personalPageChangePassword.jsp">
                        <i class="fa fa-lock text-dark" style="background:#eee;"></i>
            ...
            <div class="col">
                    ...
                    <div class="col-sm-7">
                      ...
                      <div class="clear m-b">
                        <div class="m-b m-t-sm">
                          <span class="h4 text-dark-lter">${user.UName}</span>
                        </div>
                        <p class="m-b">
              ...
              <div class="wrapper bg-white b-b">
                <ul class="nav nav-pills nav-sm">
                  <li class="active"><a>更换密码</a></li>
                </ul>
              </div>
              <div class="div-box">
                <form class="chg-pwd-form" id="chg_pwd_form" action="<%=path %>/usercenter/password">
                  <div class="control-group">
                    <label class="control-label"><i style="color: red"></i> 原密码</label>
                    <div class="controls">
                      <input type="password" class="input-xlarge"  id="old_pwd"  name="oldPassword">
                      <p class="help-block" id="tip_old_pwd">*您的原始密码</p>
                    </div>
                  </div>

                  <div class="control-group">
                    <label class="control-label"><i style="color: red"></i> 新密码</label>
                    <div class="controls">
                      <input type="password" class="input-xlarge"  id="new_pwd" name="newPassword">
                      <p class="help-block" id="tip_new_pwd">*新密码</p>
                    </div>
                  </div>

                  <div class="control-group">
                    <label class="control-label"><i style="color: red"></i> 再键入</label>
                    <div class="controls">
                      <input type="password" class="input-xlarge"  id="new_pwd_again" value="">
                      <p class="help-block" id="tip_new_pwd_again">*再次键入密码</p>
                    </div>
                  </div>
