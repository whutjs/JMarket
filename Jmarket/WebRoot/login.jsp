  ...
  <nav class="navbar navbar-inverse no-border navbar-fixed-top" role="navigation">
    ...
    <div class="content-container">
      <ul class="breadcrumb">
        ...
        <li class="breadcrumb-second-level">登录页</li>
      </ul>
      <div class="col-md-12">
        <h1 class="heading1">
          <span class="maintext">登录</span>
          <span class="subtext">记住一定要用交大邮箱登录哦</span>
        </h1>
        <div class="col-md-6">
          <form class="login-form" id="login_form" action="<%=path %>/login/index" method="post">
            <div class="form-group avatar-form-group">
              <div class="user">
                <span class="fa fa-user glyphicon-logo" aria-hidden="true" style="line-height:80px;"></span>
              </div>
            </div>
            <div class="input-group input-group-line">
              <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
              <input type="email" class="form-control login-input" id="input_email" placeholder="交大邮箱" aria-describedby="basic-addon1" name="UEmail">
            </div>
           <p id="err_mail_tip" style="display: none; text-align: left;"></p>
              <s:actionerror />
              <!-- style=" text-align: left; color:red; font-size:14px;" -->
            <div class="input-group input-group-line">
              <span class="input-group-addon" id="basic-addon2"><i class="fa fa-lock"></i></span>
              <input type="password" class="form-control login-input" id="input_password" placeholder="您的密码" aria-describedby="basic-addon2" name="UPassword">
            </div>
              <p id="err_mail_psw_tip" style="display: none; text-align: left;"></p>
            <div class="checkbox" style="margin-bottom: 10px; !important;">
              <label>
                <input type="checkbox" class="login-input">记住我
              </label>
            </div>
            <button type="submit" class="btn btn-login btn-disabled" id="login_button" disabled="disabled">登录</button>
            <div class="form-group">
              <!--<a href="#" id="forget_password">忘记密码？</a>-->
                <a href="#" id="forget_password" onclick="forgetPassword()">忘记密码?</a>
            </div>
          </form>
        </div>
        <div class="col-md-6">
          <div class="newcustomer">
            <h2 class="heading2">新用户注册账户 </h2>
            <br>
            <br>
            <div class="loginbox">
              <p>新的用户请注意：</p>
              <p style="margin-left: 20px;">目前，我们仅支持交大邮箱进行注册，因此，如果您希望使用本网站的服务，请使用交大邮箱进行注册。</p>
              <br>
              <br>
              <a href="<%=path %>/register.jsp" class="btn btn-orange">前往注册</a>
            </div>
          </div>
        </div>
      </div>
