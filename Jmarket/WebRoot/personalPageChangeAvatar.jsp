                  ...
                  <ul class="nav bg clearfix">
                    ...
                    <li>
                      <a href="<%=path %>/personalPageChangeAvatar.jsp">
                        <i class="fa fa-camera text-danger-lt" style="background:#eee;"></i>
          ...
          <div class="hbox hbox-auto-xs hbox-auto-sm m-t-lg">
            <div class="col">
              ...
              <div class="post-list" style="text-align:center;">
                  <div style="width:300px;height:400px;border:1px dotted #FFD300;text-align:center;margin:auto;padding:20px;">
                      <input id="imageify0" name="imageify" type="file" style="text-align:center;"/>
	                  <div style="text-align:center;">
	                      <img src='<%=path%>/images/user.png' id='img0' style='max-width:200px;'>
	                  </div> 
                  </div>
              </div>
            </div>
...
<script type="text/javascript" src="<%=path %>/myjs/crop/swfobject.js"></script>
<script type="text/javascript" src="<%=path %>/myjs/crop/fullAvatarEditor.js"></script>
<script type="text/javascript">
        $(document).ready(function(){
            $("#imageify0").uploadify({
                'fileObjName' : 'file', //提交时候的字段名，和struts2里面用来接收File的字段名一致
                 method : 'get',            //以get方式上传                
                'buttonText':'修改头像',        //上传按钮的文字
                ...
                'onUploadSuccess' : function(file, data, response) {    //上传成功后触发的事件          
                 ...
                 alert("用户头像更换成功");
                  window.location.href="<%=path%>/usercenter/message?type=1"; 
                }
            });
