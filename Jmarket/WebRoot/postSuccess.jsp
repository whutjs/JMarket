...
<div class="wrapper wrapper_navbar_navbar at-top">
    <nav class="navbar navbar-inverse no-border navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">JMarket</a>
            </div>
	...
	<c:choose>
          ...
          <div class="form-group">
            <input type="text" class="form-control" placeholder="感兴趣的东西..." id="search_input" name="search_item">
          </div>
    ...
    <div class="col-md-12">
        <form class="post-form" id="post_form" name="post_form">
            ...
            <ul id="progressbar">
                <li id="pro1">选择分类</li>
                <li id="pro2">填写明细</li>
                <li id="pro3" class="active">完成发布</li>
            </ul>
