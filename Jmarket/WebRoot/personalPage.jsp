...
<head>
  ...
  <link rel="stylesheet" href="<%=path %>/mycss/personal.css" type="text/css">
              ...
              <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0"
                ...
                <nav class="nav-primary hidden-xs">
                  <ul class="nav bg clearfix">
                    ...
                    <li>
                      <a>
                        <i class="fa fa-user text-warning" style="background:#eee;"></i>
            ...
            <div class="col">
                    ...
                    <div class="col-sm-7">
                      ...
                      <div class="clear m-b">
                        <div class="m-b m-t-sm">
                          <span class="h4 text-dark-lter font-bold">${user.UName}</span>
                        </div>
                        <p class="m-b">
              ...
              <div class="other-profile">
                <div class="padder">
                  <div class="m-l-lg">
                    <div>
                      <a class="pull-left thumb-sm m-l-n m-t-sm btn btn-sm btn-self-define btn-rounded btn-default btn-icon">
                        <i class="fa fa-envelope color-self-define"></i>
                      </a>
                      <div class="m-l-lg panel b-a">
                        <div class="panel-heading pos-rlt">
                          <span class="arrow left pull-up"></span>
                          <span class="fa fa-angle-right m-r-md"></span>我的邮箱<span class="item-content">${user.UEmail } </span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="padder">
                  <div class="m-l-lg">
                    <div>
                      <a class="pull-left thumb-sm m-l-n m-t-sm btn btn-sm btn-self-define btn-rounded btn-default btn-icon">
                        <i class="fa fa-wechat color-self-define"></i>
                      </a>
                      <div class="m-l-lg panel b-a">
                        <div class="panel-heading pos-rlt">
                          <span class="arrow left pull-up"></span>
                          <span class="fa fa-angle-right m-r-md"></span>微信号<span class="item-content">${user.UWechat}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="padder">
                  <div class="m-l-lg">
                    <div>
                      <a class="pull-left thumb-sm m-l-n m-t-sm btn btn-sm btn-self-define btn-rounded btn-default btn-icon">
                        <i class="fa fa-qq color-self-define"></i>
                      </a>
                      <div class="m-l-lg panel b-a">
                        <div class="panel-heading pos-rlt">
                          <span class="arrow left pull-up"></span>
                          <span class="fa fa-angle-right m-r-md"></span>QQ<span class="item-content"> ${user.UQq}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="padder">
                  <div class="m-l-lg">
                    <div>
                      <a class="pull-left thumb-sm m-l-n m-t-sm btn btn-sm btn-self-define btn-rounded btn-default btn-icon">
                        <i class="fa fa-mobile color-self-define"></i>
                      </a>
                      <div class="m-l-lg panel b-a">
                        <div class="panel-heading pos-rlt">
                          <span class="arrow left pull-up"></span>
                          <span class="fa fa-angle-right m-r-md"></span>手机号<span class="item-content"> ${user.UPhone}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="padder">
                  <div class="m-l-lg">
                    <div>
                      <a class="pull-left thumb-sm m-l-n m-t-sm btn btn-sm btn-self-define btn-rounded btn-default btn-icon">
                        <i class="fa fa-calendar color-self-define"></i>
                      </a>
                      <div class="m-l-lg panel b-a">
                        <div class="panel-heading pos-rlt">
                          <span class="arrow left pull-up"></span>
                          <span class="fa fa-angle-right m-r-md"></span>注册日期<span class="item-content"> ${user.URegtime}</span>
                        </div>
                      </div>
                    </div>
                  </div>
